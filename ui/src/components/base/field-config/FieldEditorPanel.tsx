  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="max-h-[420px] overflow-y-auto px-3 pb-3">
        ...
        <button
          type="button"
          className="mb-3 flex w-full cursor-pointer items-center gap-2 rounded border border-base bg-fill-tertiary px-2 py-1.5 text-sm hover:bg-fill-secondary"
...
function ConfigDropdown({
  ...
  return (
    <div className="relative">
      <button
        type="button"
        className="flex w-full cursor-pointer items-center justify-between rounded border border-base bg-fill-tertiary px-2 py-1.5 text-xs hover:bg-fill-secondary"
        onClick={() => setOpen((v) => !v)}
      >
