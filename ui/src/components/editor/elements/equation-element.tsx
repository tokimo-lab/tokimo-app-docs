        ...
        {editing ? (
          <div className="flex flex-col items-center gap-2">
            <textarea
              ...
              placeholder="E = mc^2"
              className="w-full max-w-lg resize-none rounded border border-border-base bg-surface-sunken px-3 py-2 font-mono text-sm text-fg-primary outline-none focus:border-accent"
              rows={2}
            />
